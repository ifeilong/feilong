...
public final class URLUtil{
    ...
    private static URL toFileURL(String filePath){
        try{
            ...
            throw new URIParseException(formatPattern("filePath:[{}]", filePath), e);
        }
    }
    ...
    public static URI toURI(URL url){
        ...
        try{
            ...
            throw new URIParseException(formatPattern("input url:[{}]", url), e);
        }
    }
    ...
    public static InputStream openStream(URL url){
        try{
            ...
            throw new UncheckedIOException(formatPattern("openStream url:[{}]", url), e);
        }
    }
    ...
    public static String getUnionUrl(URL context,String spec){
        try{
            ...
            String message = formatPattern("context:[{}],spec:[{}]", context, spec);
