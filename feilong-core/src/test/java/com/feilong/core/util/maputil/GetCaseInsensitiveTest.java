...
public class GetCaseInsensitiveTest{
    ...
    //---------------------------------------------------------------
    @Test
    public void testGetCaseInsensitive2(){
        Map<String, String> map = newLinkedHashMap();
        map.put("name", "jim");
        map.put("address", "shanghai");
    ...
    @Test
    public void testGetCaseInsensitiveNullKey(){
        Map<String, String> map = newLinkedHashMap();
        map.put("name", "jim");
        map.put("address", "shanghai");
    ...
    public void testGetNullMap(){
        assertEquals(null, MapUtil.getCaseInsensitive(null, "address"));
    }
}
