...
public class TokenizeToSetDefaultDelimitersParameterizedTest extends Abstract1ParamAndResultParameterizedTest<String, String[]>{

    @Parameters(name = "index:{index}:StringUtil.tokenizeToSet({0})={1}")
    ...
    public void tokenizeToSet(){
        assertThat(StringUtil.tokenizeToSet(input1), contains(expectedValue));
    }
