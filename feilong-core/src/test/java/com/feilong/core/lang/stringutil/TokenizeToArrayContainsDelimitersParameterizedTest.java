...
public class TokenizeToArrayContainsDelimitersParameterizedTest
                extends Abstract3ParamsAndResultParameterizedTest<String, String, Object, Boolean>{
    ...
    public static Iterable<Object[]> data(){
        return toList(//
                        ...
                        toArray("feilong@jim@2@3@4", "@", "jim", true),
    ...
    @Test
    public void test(){
        assertEquals(expectedValue, StringUtil.tokenizeToArrayContains(input1, input2, input3));
    }
}