...
public class TokenizeToListDefaultDelimitersParameterizedTest extends Abstract1ParamAndResultParameterizedTest<String, String[]>{

    @Parameters(name = "index:{index}:StringUtil.tokenizeToList({0})={1}")
    ...
    public void tokenizeToSet(){
        assertThat(StringUtil.tokenizeToList(input1), contains(expectedValue));
    }
