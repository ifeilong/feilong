...
public class ExecuteOnlyPartitionPerHandlerTest extends AbstractExcuteTest{

    /** The Constant log. */
    private static final Logger LOGGER = LoggerFactory.getLogger(ExecuteOnlyPartitionPerHandlerTest.class);
    ...
    public void testExecute(){
        ...
        ThreadUtil.execute(
                        ...
                        (perBatchList,partitionThreadEntity,paramsMap) -> {
                            final AtomicInteger atomicInteger2 = (AtomicInteger) paramsMap1.get("result");
    ...
    public void testExecuteNullList(){
        ThreadUtil.execute(null, EmptyPartitionPerHandler.INSTANCE);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testExecuteEmptyList(){
        ThreadUtil.execute(Collections.<Integer> emptyList(), EmptyPartitionPerHandler.INSTANCE);
    }
