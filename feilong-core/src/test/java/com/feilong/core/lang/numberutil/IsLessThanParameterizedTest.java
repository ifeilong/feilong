...
public class IsLessThanParameterizedTest extends Abstract2ParamsAndResultParameterizedTest<Number, Number, Boolean>{
     ...
     * @return the iterable
     */
    @Parameters(name = "index:{index},NumberUtil.isLessThan({0}, {1})={2}")
    ...
    public void testGetSubtractValue(){
        assertEquals(expectedValue, NumberUtil.isLessThan(input1, input2));
    }
