 ...
 */
public class SubstringBeginIndexTest{
    ...
    public void substring(){
        assertEquals(
                        "src/main/java/com/shop/web/command/PageCacheCommand.java",
                        StringUtil.substring("Index: src/main/java/com/shop/web/command/PageCacheCommand.java", "Index: ".length()));
