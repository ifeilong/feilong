 ...
 */
public class GetFirstDateOfThisYearTest{
    ...
    public void testGetFirstDateOfThisYear(){
        assertEquals(
                        toDate("2016-01-01 00:00:00", COMMON_DATE_AND_TIME),
                        getFirstDateOfThisYear(toDate("2016-08-22 01:00:00", COMMON_DATE_AND_TIME)));
    }
