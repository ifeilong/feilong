...
import static com.feilong.core.date.DateUtil.getIntervalMinute;
...
public class GetIntervalMinuteParameterizedTest extends Abstract3ParamsAndResultParameterizedTest<String, String, String, Integer>{
