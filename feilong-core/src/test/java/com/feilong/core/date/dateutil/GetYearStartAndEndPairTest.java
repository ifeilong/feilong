...
import static com.feilong.core.date.DateUtil.getYearStartAndEndPair;
...
public class GetYearStartAndEndPairTest{
    ...
    public void testGetYearStartAndEndPair(){
        ...
        assertEquals(getLastDateOfThisYear(NOW), yearStartAndEndPair.getRight());
    }
    ...
    public void testGetYearStartAndEndPairNullDate(){
        getYearStartAndEndPair(null);
    }
}
