...
import com.feilong.lib.xstream.converters.javabean.JavaBeanProvider;
import com.feilong.lib.xstream.converters.reflection.FieldKeySorter;
...
public class XStreamer{
    ...
    private final static TypePermission[] PERMISSIONS = {
                                                          ...
                                                          new WildcardTypePermission(
                                                                          new String[] { JVM.class.getPackage().getName() + ".**" }),
     ...
     * @throws com.feilong.lib.xstream.XStreamException
    ...
    public void toXML(final XStream xstream,final Object obj,final Writer out) throws IOException{
        final XStream outer = new XStream(null);
     ...
     * @see #toXML(XStream, Object, Writer)
     */
    public Object fromXML(final HierarchicalStreamDriver driver,final String xml) throws ClassNotFoundException,ObjectStreamException{
        try{
     ...
     *            the XML data
     * @param permissions
     *            the permissions to use (ensure that they include the defaults)
     * @throws ClassNotFoundException
     *             if a class in the XML stream cannot be found
     * @throws ObjectStreamException
     *             if the XML contains non-deserializable elements
     ...
     *            the implementation to use
     * @param xml
     *            the {@link Reader} providing the XML data
     * @throws IOException
     ...
     * @since 1.2
     */
    public Object fromXML(final HierarchicalStreamDriver driver,final Reader xml) throws IOException,ClassNotFoundException{
