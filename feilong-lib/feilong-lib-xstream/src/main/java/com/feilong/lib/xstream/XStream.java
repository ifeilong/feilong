...
import com.feilong.lib.xstream.converters.basic.BigDecimalConverter;
import com.feilong.lib.xstream.converters.basic.BigIntegerConverter;
import com.feilong.lib.xstream.converters.basic.BooleanConverter;
import com.feilong.lib.xstream.converters.basic.ByteConverter;
import com.feilong.lib.xstream.converters.basic.CharConverter;
import com.feilong.lib.xstream.converters.basic.DateConverter;
import com.feilong.lib.xstream.converters.basic.DoubleConverter;
import com.feilong.lib.xstream.converters.basic.FloatConverter;
import com.feilong.lib.xstream.converters.basic.IntConverter;
import com.feilong.lib.xstream.converters.basic.LongConverter;
import com.feilong.lib.xstream.converters.basic.NullConverter;
import com.feilong.lib.xstream.converters.basic.ShortConverter;
import com.feilong.lib.xstream.converters.basic.StringBufferConverter;
import com.feilong.lib.xstream.converters.basic.StringConverter;
import com.feilong.lib.xstream.converters.basic.URIConverter;
import com.feilong.lib.xstream.converters.basic.URLConverter;
import com.feilong.lib.xstream.converters.collections.ArrayConverter;
import com.feilong.lib.xstream.converters.collections.BitSetConverter;
import com.feilong.lib.xstream.converters.collections.CharArrayConverter;
import com.feilong.lib.xstream.converters.collections.CollectionConverter;
import com.feilong.lib.xstream.converters.collections.MapConverter;
import com.feilong.lib.xstream.converters.collections.PropertiesConverter;
import com.feilong.lib.xstream.converters.collections.SingletonCollectionConverter;
import com.feilong.lib.xstream.converters.collections.SingletonMapConverter;
import com.feilong.lib.xstream.converters.collections.TreeMapConverter;
import com.feilong.lib.xstream.converters.collections.TreeSetConverter;
import com.feilong.lib.xstream.converters.extended.ColorConverter;
import com.feilong.lib.xstream.converters.extended.DynamicProxyConverter;
import com.feilong.lib.xstream.converters.extended.EncodedByteArrayConverter;
import com.feilong.lib.xstream.converters.extended.FileConverter;
import com.feilong.lib.xstream.converters.extended.FontConverter;
import com.feilong.lib.xstream.converters.extended.GregorianCalendarConverter;
import com.feilong.lib.xstream.converters.extended.JavaClassConverter;
import com.feilong.lib.xstream.converters.extended.JavaFieldConverter;
import com.feilong.lib.xstream.converters.extended.JavaMethodConverter;
import com.feilong.lib.xstream.converters.extended.LocaleConverter;
import com.feilong.lib.xstream.converters.extended.LookAndFeelConverter;
import com.feilong.lib.xstream.converters.extended.SqlDateConverter;
import com.feilong.lib.xstream.converters.extended.SqlTimeConverter;
import com.feilong.lib.xstream.converters.extended.SqlTimestampConverter;
import com.feilong.lib.xstream.converters.extended.TextAttributeConverter;
import com.feilong.lib.xstream.converters.reflection.ExternalizableConverter;
...
import com.feilong.lib.xstream.converters.reflection.SerializableConverter;
import com.feilong.lib.xstream.core.ClassLoaderReference;
import com.feilong.lib.xstream.core.DefaultConverterLookup;
import com.feilong.lib.xstream.core.JVM;
import com.feilong.lib.xstream.core.MapBackedDataHolder;
import com.feilong.lib.xstream.core.ReferenceByIdMarshallingStrategy;
import com.feilong.lib.xstream.core.ReferenceByXPathMarshallingStrategy;
import com.feilong.lib.xstream.core.TreeMarshallingStrategy;
import com.feilong.lib.xstream.core.util.CompositeClassLoader;
...
import com.feilong.lib.xstream.core.util.SelfStreamingInstanceChecker;
...
import com.feilong.lib.xstream.io.StatefulWriter;
import com.feilong.lib.xstream.mapper.AnnotationConfiguration;
import com.feilong.lib.xstream.mapper.ArrayMapper;
import com.feilong.lib.xstream.mapper.AttributeAliasingMapper;
import com.feilong.lib.xstream.mapper.AttributeMapper;
import com.feilong.lib.xstream.mapper.CachingMapper;
import com.feilong.lib.xstream.mapper.ClassAliasingMapper;
import com.feilong.lib.xstream.mapper.DefaultImplementationsMapper;
import com.feilong.lib.xstream.mapper.DefaultMapper;
import com.feilong.lib.xstream.mapper.DynamicProxyMapper;
import com.feilong.lib.xstream.mapper.ElementIgnoringMapper;
import com.feilong.lib.xstream.mapper.FieldAliasingMapper;
import com.feilong.lib.xstream.mapper.ImmutableTypesMapper;
import com.feilong.lib.xstream.mapper.ImplicitCollectionMapper;
import com.feilong.lib.xstream.mapper.LocalConversionMapper;
import com.feilong.lib.xstream.mapper.Mapper;
import com.feilong.lib.xstream.mapper.MapperWrapper;
import com.feilong.lib.xstream.mapper.OuterClassMapper;
import com.feilong.lib.xstream.mapper.PackageAliasingMapper;
import com.feilong.lib.xstream.mapper.SecurityMapper;
import com.feilong.lib.xstream.mapper.SystemAttributeAliasingMapper;
import com.feilong.lib.xstream.security.AnyTypePermission;
import com.feilong.lib.xstream.security.ArrayTypePermission;
import com.feilong.lib.xstream.security.ExplicitTypePermission;
import com.feilong.lib.xstream.security.InterfaceTypePermission;
import com.feilong.lib.xstream.security.NoPermission;
import com.feilong.lib.xstream.security.NoTypePermission;
import com.feilong.lib.xstream.security.NullPermission;
import com.feilong.lib.xstream.security.PrimitiveTypePermission;
import com.feilong.lib.xstream.security.RegExpTypePermission;
import com.feilong.lib.xstream.security.TypeHierarchyPermission;
import com.feilong.lib.xstream.security.TypePermission;
import com.feilong.lib.xstream.security.WildcardTypePermission;
 ...
 * 
 * <p>
 * XStream contains a map of {@link com.feilong.lib.xstream.converters.Converter} instances, each
 ...
 * non-standard converters are supplied in the {@link com.feilong.lib.xstream.converters.extended}
 * package and you can create your own by implementing the
 * {@link com.feilong.lib.xstream.converters.Converter} interface.
 * </p>
 * 
 * <p>
 * <hr>
 ...
 * {@link com.feilong.lib.xstream.converters.reflection.ReflectionConverter} as the fallback
 * converter.
 * </p>
 * 
 * <p>
...
public class XStream{
    ...
    private static final String            ANNOTATION_MAPPER_TYPE                = "com.feilong.lib.xstream.mapper.AnnotationMapper";
     ...
     *            the reflection provider to use or <em>null</em> for best
     *            matching Provider
     * @param mapper
     *            the instance with the {@link Mapper} chain or <em>null</em> for the default
     *            chain
     * @param driver
     *            the driver instance
     * @throws InitializationException
     ...
     *            the reference to the {@link ClassLoader} to use
     * @throws InitializationException
     *             in case of an initialization problem
     * @since 1.4.5
     */
     ...
     *            the instance that is used to lookup the converters
     * @param converterRegistry
     *            an instance to manage the converter instances or <em>null</em>
    ...
    private Mapper buildMapper(){
        ...
        if (JVM.isVersion(5)){
            mapper = buildMapperDynamically(
                            "com.feilong.lib.xstream.mapper.EnumMapper",
        ...
        if (JVM.isVersion(8)){
            mapper = buildMapperDynamically(
                            "com.feilong.lib.xstream.mapper.LambdaMapper",
                            new Class[] { Mapper.class },
                            new Object[] { mapper });
        }
        ...
        if (JVM.isVersion(5)){
            mapper = buildMapperDynamically(
                            ...
                            new Object[] { mapper, converterRegistry, converterLookup, classLoaderReference, reflectionProvider });
        }
    ...
    private Mapper buildMapperDynamically(String className,Class[] constructorParamTypes,Object[] constructorParamValues){
        try{
            ...
            throw new com.feilong.lib.xstream.InitializationException("Could not instantiate mapper : " + className, e);
    ...
    protected void setupConverters(){
        ...
        if (JVM.isVersion(4)){
            ...
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.extended.SubjectConverter",
                            PRIORITY_NORMAL,
                            new Class[] { Mapper.class },
                            new Object[] { mapper });
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.extended.ThrowableConverter",
                            PRIORITY_NORMAL,
                            new Class[] { ConverterLookup.class },
                            new Object[] { converterLookup });
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.extended.StackTraceElementConverter",
                            PRIORITY_NORMAL,
                            null,
                            null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.extended.CurrencyConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.extended.RegexPatternConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.extended.CharsetConverter", PRIORITY_NORMAL, null, null);
        }

        if (JVM.isVersion(5)){
            // late bound converters - allows XStream to be compiled on earlier JDKs
            if (JVM.loadClassForName("javax.xml.datatype.Duration") != null){
                registerConverterDynamically("com.feilong.lib.xstream.converters.extended.DurationConverter", PRIORITY_NORMAL, null, null);
            }
            registerConverterDynamically("com.feilong.lib.xstream.converters.enums.EnumConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.enums.EnumSetConverter",
                            PRIORITY_NORMAL,
                            new Class[] { Mapper.class },
                            new Object[] { mapper });
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.enums.EnumMapConverter",
                            PRIORITY_NORMAL,
                            new Class[] { Mapper.class },
                            new Object[] { mapper });
            registerConverterDynamically("com.feilong.lib.xstream.converters.basic.StringBuilderConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.basic.UUIDConverter", PRIORITY_NORMAL, null, null);
        }
        if (JVM.loadClassForName("javax.activation.ActivationDataFlavor") != null){
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.extended.ActivationDataFlavorConverter",
                            PRIORITY_NORMAL,
                            null,
                            null);
        }
        if (JVM.isVersion(7)){
            registerConverterDynamically("com.feilong.lib.xstream.converters.extended.PathConverter", PRIORITY_NORMAL, null, null);
        }
        if (JVM.isVersion(8)){
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.ChronologyConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.DurationConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.HijrahDateConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.JapaneseDateConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.JapaneseEraConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.InstantConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.LocalDateConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.LocalDateTimeConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.LocalTimeConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.MinguoDateConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.MonthDayConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.OffsetDateTimeConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.OffsetTimeConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.PeriodConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.time.SystemClockConverter",
                            PRIORITY_NORMAL,
                            new Class[] { Mapper.class },
                            new Object[] { mapper });
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.ThaiBuddhistDateConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.time.ValueRangeConverter",
                            PRIORITY_NORMAL,
                            new Class[] { Mapper.class },
                            new Object[] { mapper });
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.time.WeekFieldsConverter",
                            PRIORITY_NORMAL,
                            new Class[] { Mapper.class },
                            new Object[] { mapper });
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.YearConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.YearMonthConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.ZonedDateTimeConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically("com.feilong.lib.xstream.converters.time.ZoneIdConverter", PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                            "com.feilong.lib.xstream.converters.reflection.LambdaConverter",
                            PRIORITY_NORMAL,
    ...
    private void registerConverterDynamically(String className,int priority,Class[] constructorParamTypes,Object[] constructorParamValues){
        try{
            ...
            throw new com.feilong.lib.xstream.InitializationException("Could not instantiate converter : " + className, e);
        }catch (LinkageError e){
            throw new com.feilong.lib.xstream.InitializationException("Could not instantiate converter : " + className, e);
        }
    }
    ...
    protected void setupImmutableTypes(){
        ...
        if (JVM.isVersion(7)){
            ...
            if (type != null){
                ...
                }catch (NoSuchMethodException e){}catch (SecurityException e){}catch (IllegalAccessException e){}catch (InvocationTargetException e){}
            }
        }
    ...
    public void alias(String name,Class type){
        if (classAliasingMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + ClassAliasingMapper.class.getName() + " available");
        }
    ...
    public void aliasPackage(String name,String pkgName){
        if (packageAliasingMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + PackageAliasingMapper.class.getName() + " available");
        }
    ...
    public void aliasField(String alias,Class definedIn,String fieldName){
        if (fieldAliasingMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + FieldAliasingMapper.class.getName() + " available");
        }
    ...
    public void aliasAttribute(String alias,String attributeName){
        if (attributeAliasingMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + AttributeAliasingMapper.class.getName() + " available");
        }
    ...
    public void useAttributeFor(String fieldName,Class type){
        if (attributeMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + AttributeMapper.class.getName() + " available");
        }
    ...
    public void addDefaultImplementation(Class defaultImplementation,Class ofType){
        if (defaultImplementationsMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + DefaultImplementationsMapper.class.getName() + " available");
        }
     ...
     *            <code>true</code> if support at deserialization time is required for compatibility at the
    ...
    public void addImmutableType(final Class type,final boolean isReferenceable){
        if (immutableTypesMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + ImmutableTypesMapper.class.getName() + " available");
        }
    ...
    public void registerLocalConverter(Class definedIn,String fieldName,Converter converter){
        if (localConversionMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + LocalConversionMapper.class.getName() + " available");
        }
        ...
        switch (mode) {
            ...
            case SINGLE_NODE_XPATH_RELATIVE_REFERENCES:
                setMarshallingStrategy(
                                new ReferenceByXPathMarshallingStrategy(
     ...
     * @param keyFieldName
     *            the name of the field of the itemType that is used for the key in the map
     * @since 1.4
     */
    ...
    public void addImplicitMap(Class ownerType,String fieldName,String itemName,Class itemType,String keyFieldName){
        if (implicitCollectionMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + ImplicitCollectionMapper.class.getName() + " available");
        }
     ...
     * </p>
     * 
     * @see #createObjectOutputStream(com.feilong.lib.xstream.io.HierarchicalStreamWriter,
     *      String)
     * @see #createObjectInputStream(com.feilong.lib.xstream.io.HierarchicalStreamReader)
     * @since 1.0.3
     */
     ...
     *
     * @see #createObjectOutputStream(com.feilong.lib.xstream.io.HierarchicalStreamWriter, String)
     * @see #createObjectInputStream(com.feilong.lib.xstream.io.HierarchicalStreamReader)
     * @since 1.4.10
     */
     ...
     * @since 1.1.3
     * @throws InitializationException
     *             if no {@link ElementIgnoringMapper} is available
     */
    public void omitField(Class definedIn,String fieldName){
        if (elementIgnoringMapper == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + ElementIgnoringMapper.class.getName() + " available");
        }
     ...
     *
     * @param pattern
     *            the name pattern as regular expression
     * @since 1.4.5
     */
    ...
    public void processAnnotations(final Class[] types){
        if (annotationConfiguration == null){
            throw new com.feilong.lib.xstream.InitializationException("No " + ANNOTATION_MAPPER_TYPE + " available");
        }
     ...
     *
     * @param regexps
     *            the regular expressions to allow type names
     * @since 1.4.7
     */
     ...
     * <li>**: arbitrary number of non-control characters including separator, e.g. for types in a package and subpackages like
     * 'java.lang.**'</li>
     * </ul>
     *
     * @param patterns
     *            the patterns to allow type names
     * @since 1.4.7
     */
     ...
     *
     * @param regexps
     *            the regular expressions to forbid type names
     * @since 1.4.7
     */
    ...
    private class InternalBlackList implements Converter{
        ...
        public boolean canConvert(final Class type){
            return (type == void.class || type == Void.class)
                            || (!securityInitialized && type != null && (type.getName().equals("java.beans.EventHandler")
                                            || type.getName().endsWith("$LazyIterator") || type.getName().startsWith("javax.crypto.")));
        }
