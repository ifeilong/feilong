 ...
 * should be thrown.</p>
 * 
 * <p>If working with the high level {@link com.feilong.lib.xstream.XStream} facade,
 * you can register new converters using the XStream.registerConverter() method.</p>
 * 
 * <p>If working with the lower level API, the
 * {@link com.feilong.lib.xstream.converters.ConverterLookup} implementation is
 ...
 * should implement {@link com.feilong.lib.xstream.converters.SingleValueConverter}.
 * {@link com.feilong.lib.xstream.converters.basic.AbstractSingleValueConverter}
 * provides a starting point.</p>
 * 
 * <p>{@link com.feilong.lib.xstream.converters.collections.AbstractCollectionConverter}
 * provides a starting point for objects that hold a collection of other objects
 * (such as Lists and Maps).</p>
 *
 * @author Joe Walnes
 * @see com.feilong.lib.xstream.XStream
 * @see com.feilong.lib.xstream.converters.ConverterLookup
 * @see com.feilong.lib.xstream.converters.basic.AbstractSingleValueConverter
 * @see com.feilong.lib.xstream.converters.collections.AbstractCollectionConverter
 */
