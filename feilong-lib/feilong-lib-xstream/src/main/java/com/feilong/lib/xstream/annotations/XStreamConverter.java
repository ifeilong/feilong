 ...
 * <ul>
 * <li>{@link com.feilong.lib.xstream.mapper.Mapper}: The current mapper chain of the XStream
 * instance.</li>
 * <li>{@link com.feilong.lib.xstream.core.ClassLoaderReference}: The reference to the class
 * loader used by the XStream instance to deserialize the objects.</li>
 * <li>{@link com.feilong.lib.xstream.converters.reflection.ReflectionProvider}: The reflection
 * provider used by the reflection based converters of the current XStream instance.</li>
 * <li>{@link com.feilong.lib.xstream.converters.ConverterLookup}: The lookup for converters
 ...
 * {@link com.feilong.lib.xstream.annotations.XStreamConverters} or {@link #useImplicitType()}
 * == false.</li>
 * <li>{@link com.feilong.lib.xstream.core.JVM}: Utility e.g. to load classes.</li>
 ...
 * {@link com.feilong.lib.xstream.converters.Converter} as well as
 * {@link com.feilong.lib.xstream.converters.SingleValueConverter} extend this interface. The
 * {@link com.feilong.lib.xstream.mapper.AnnotationMapper} can only handle these two
