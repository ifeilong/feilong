...
/**
 * <p>
 * Test case for <code>MethodUtils</code>
 * </p>
 *
 * @version $Id$
 */
public class MethodUtilsTestCase extends TestCase{
    ...
    /**
     * <p>
     * Test <code>getAccessibleMethod</code>.
     */
    ...
    /**
     * <p>
     * Test <code>invokeExactMethod</code>.
     */
    ...
    public void testSimpleStatic1(){
        ...
        try{
            ...
            MethodUtils.invokeMethod(bean, "incrementCounter", new Object[] { new Integer(5) }, new Class[] { Integer.TYPE });
    ...
    public void testSimpleStatic2(){
        ...
        try{
            ...
            // Increment via specified-argument version
            MethodUtils.invokeExactMethod(bean, "incrementCounter", new Object[] { new Integer(5) }, new Class[] { Integer.TYPE });
    ...
    public void testSimpleStatic3(){
        ...
        try{
            ...
            final Method incrementCounterMethod2 = MethodUtils
                            .getAccessibleMethod(TestBean.class, "incrementCounter", new Class[] { Integer.TYPE });
            ...
            // Increment via specified-argument version
            incrementCounterMethod2.invoke(null, new Object[] { new Integer(5) });
