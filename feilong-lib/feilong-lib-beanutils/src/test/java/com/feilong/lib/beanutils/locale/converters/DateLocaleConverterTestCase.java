...
public class DateLocaleConverterTestCase extends BaseLocaleConverterTestCase{
    ...
    public void testConstructorMain(){
        ...
        converter = new DateLocaleConverter(defaultValue, localizedLocale, localizedDatePattern, true);
        ...
        converter = new DateLocaleConverter(defaultValue, localizedLocale, defaultDatePattern, false);
