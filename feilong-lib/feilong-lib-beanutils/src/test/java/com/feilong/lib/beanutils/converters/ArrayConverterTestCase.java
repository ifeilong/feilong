...
public class ArrayConverterTestCase extends TestCase{
    ...
    public void testComponentIntegerConverter(){
        ...
        final Integer[] IntegerArray = new Integer[] {
                                                       new Integer(intArray[0]),
                                                       new Integer(intArray[1]),
                                                       new Integer(intArray[2]),
                                                       new Integer(intArray[3]) };
    ...
    public void testStringArrayToNumber(){
        ...
        final Integer[] expectedInteger = new Integer[] {
                                                          new Integer(expectedInt[0]),
                                                          new Integer(expectedInt[1]),
                                                          new Integer(expectedInt[2]),
                                                          new Integer(expectedInt[3]) };
