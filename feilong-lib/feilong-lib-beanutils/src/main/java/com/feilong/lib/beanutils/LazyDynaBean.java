 ...
 *
 * <p>
 * <b><u>Getting Property Values</u></b>
 * </p>
 * <p>
 * Calling any of the <code>get()</code> methods, for a property which
 * doesn't exist, returns <code>null</code> in this implementation.
 * </p>
 *
 * <p>
 * <b><u>Setting Simple Properties</u></b>
 * </p>
 * <p>
 * The <code>LazyDynaBean</code> will automatically add a property to the <code>DynaClass</code>
 * if it doesn't exist when the <code>set(name, value)</code> method is called.
 * </p>
 *
 ...
 *
 * <p>
 * <b><u>Setting Indexed Properties</u></b>
 * </p>
 * <p>
 * If the property <b>doesn't</b> exist, the <code>LazyDynaBean</code> will automatically add
 ...
 *
 * <p>
 * If the indexed property <b>does</b> exist in the <code>DynaClass</code> but is set to
 ...
 * or <code>Array</code> so that it is big enough to accomodate the index being set.
 * </p>
 *
 * <code>DynaBean myBean = new LazyDynaBean();</code></br>
 ...
 *
 * <p>
 * <b><u>Setting Mapped Properties</u></b>
 * </p>
 * <p>
 * If the property <b>doesn't</b> exist, the <code>LazyDynaBean</code> will automatically add
 ...
 * the <code>defaultMappedProperty(name)</code> method.
 * </p>
 *
 * <code>DynaBean myBean = new LazyDynaBean();</code></br>
 ...
 *
 * <p>
 * If the mapped property <b>does</b> exist in the <code>DynaClass</code> but is set to
 * <code>null</code> in the <code>LazyDynaBean</code>, then it will instantiate a
 * new <code>Map</code> as specified by the property's type in the <code>DynaClass</code>.
 * </p>
 *
 * <code>DynaBean myBean = new LazyDynaBean();</code></br>
 * <code>MutableDynaClass myClass = (MutableDynaClass)myBean.getDynaClass();</code></br>
 ...
 *
 * <p>
 * <b><u><i>Restricted</i> DynaClass</u></b>
 * </p>
 * <p>
 ...
 * doesn't exist will result in a <code>IllegalArgumentException</code> being thrown.
 * </p>
 *
 * @version $Id$
 * @see LazyDynaClass
...
public class LazyDynaBean implements DynaBean,Serializable{
     ...
     *
     * <p>
     * <strong>N.B.</strong> Returns <code>null</code> if there is no property
     ...
     *
     * <p>
     * <strong>N.B.</strong> Returns <code>null</code> if there is no 'indexed'
    ...
    public Object get(final String name,final int index){
        ...
        if (!dynaClass.getDynaProperty(name).isIndexed()){
            throw new IllegalArgumentException(
                            "Non-indexed property for '" + name + "[" + index + "]' " + dynaClass.getDynaProperty(name).getName());
        }
        ...
        if (indexedProperty.getClass().isArray()){
            ...
            throw new IllegalArgumentException(
                            "Non-indexed property for '" + name + "[" + index + "]' " + indexedProperty.getClass().getName());
        }
     ...
     *
     * <p>
     * <strong>N.B.</strong> Returns <code>null</code> if there is no 'mapped'
     * property of the specified name.
     * </p>
     *
     * @param name
    ...
    public Object get(final String name,final String key){
        ...
        if (!dynaClass.getDynaProperty(name).isMapped()){
            throw new IllegalArgumentException(
                            "Non-mapped property for '" + name + "(" + key + ")' " + dynaClass.getDynaProperty(name).getType().getName());
        }
    ...
    public void set(final String name,final int index,final Object value){
        ...
        if (!dynaClass.getDynaProperty(name).isIndexed()){
            throw new IllegalArgumentException(
                            "Non-indexed property for '" + name + "[" + index + "]'" + dynaClass.getDynaProperty(name).getType().getName());
        }
        ...
        if (type == null){
            ...
            if (type.isInterface()){
                ...
                try{
                    ...
                    throw new IllegalArgumentException(
                                    "Error instantiating indexed property of type '" + type.getName() + "' for '" + name + "' " + ex);
                }
            }
        }else{
    ...
    /**
     * <p>
     * Creates a new <code>ArrayList</code> for an 'indexed' property
     * which doesn't exist.
     * </p>
     *
     * <p>
     * This method should be overridden if an alternative <code>List</code>
     * or <code>Array</code> implementation is required for 'indexed' properties.
     * </p>
     *
     * @param name
    ...
    /**
     * <p>
     * Creates a new <code>HashMap</code> for a 'mapped' property
     * which doesn't exist.
     * </p>
     *
     * <p>
     * This method can be overridden if an alternative <code>Map</code>
    ...
    /**
     * <p>
     * Creates a new instance of the <code>Map</code>.
     * </p>
     * 
