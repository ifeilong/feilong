 ...
 *
 * <p>
 * <strong>Note:</strong> This class takes some care to ensure that when
 ...
 *
 * <p>
 * <strong>Note:</strong> A WeakHashMap bug in several 1.3 JVMs results in
 * a memory leak for those JVMs.
 * </p>
 *
 * <p>
 * <strong>Note:</strong> Of course all of this would be unnecessary if
 ...
 *
 * @param <T>
 *            the type of data stored in an instance
 * @version $Id$
