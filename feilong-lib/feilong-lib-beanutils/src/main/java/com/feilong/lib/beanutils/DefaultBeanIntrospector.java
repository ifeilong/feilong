        ...
        for (final PropertyDescriptor pd : descriptors){
            if (pd instanceof IndexedPropertyDescriptor){
                ...
                if (descriptor.getReadMethod() == null){
                    final String methodName = descriptor.getIndexedReadMethod() != null ? descriptor.getIndexedReadMethod().getName()
                                    : "get" + propName;
                    final Method readMethod = MethodUtils.getMatchingAccessibleMethod(beanClass, methodName, EMPTY_CLASS_PARAMETERS);
                    if (readMethod != null){
                        try{
                ...
                if (descriptor.getWriteMethod() == null){
                    final String methodName = descriptor.getIndexedWriteMethod() != null ? descriptor.getIndexedWriteMethod().getName()
                                    : "set" + propName;
