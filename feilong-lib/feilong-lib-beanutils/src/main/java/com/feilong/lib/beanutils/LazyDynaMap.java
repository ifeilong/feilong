 ...
 * with <i>lazy</i> map/list processing.
 * </p>
 *
 * <p>
 * Its a <i>light weight</i> <code>DynaBean</code> implementation because there is no
 ...
 * behaviour from the actual values stored in the <code>Map</code>.
 * </p>
 *
 * <p>
 * As well providing rhe standard <code>DynaBean</code> access to the <code>Map</code>'s properties
 * this class also provides the usual <i>Lazy</i> behaviour:
 * </p>
 * <ul>
 ...
 * </p>
 * <p>
 * This class implements the <code>MutableDynaClass</code> interface.
...
public class LazyDynaMap extends LazyDynaBean implements MutableDynaClass{
     ...
     * 
     */
    private static final long serialVersionUID = 3716232872185167024L;
     ...
     *
     * @param values
     *            The Map backing this <code>LazyDynaMap</code>
     */
