...
public class LocaleBeanUtilsBean extends BeanUtilsBean{
     ...
     *
     * @param localeConvertUtils
     *            use this <code>localeConvertUtils</code> to perform
     *            conversions
     * @param convertUtilsBean
     *            use this for standard conversions
     * @param propertyUtilsBean
     *            use this for property conversions
     */
    public LocaleBeanUtilsBean(final LocaleConvertUtilsBean localeConvertUtils, final ConvertUtilsBean convertUtilsBean,
     ...
     *             throws an exception
     */
    public void setProperty(final Object bean,String name,final Object value,final String pattern)
