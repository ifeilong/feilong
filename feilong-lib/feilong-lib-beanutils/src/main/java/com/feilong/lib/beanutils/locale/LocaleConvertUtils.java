 ...
 * by using a <code>LocaleConvertUtilsBean</code> instance.
 * </p>
 *
 * @version $Id$
 */
public class LocaleConvertUtils{
    ...
    /**
     * <p>
     * Gets the <code>Locale</code> which will be used when
     * no <code>Locale</code> is passed to a method.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Sets the <code>Locale</code> which will be used when
     * no <code>Locale</code> is passed to a method.
     * </p>
     *
     * <p>
