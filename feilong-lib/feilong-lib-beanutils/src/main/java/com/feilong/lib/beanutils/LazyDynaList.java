 ...
 *
 * <p>
 * All elements added to the List are stored as <code>DynaBean</code>'s:
 * </p>
 * <ul>
 ...
 * <p>
 * The <code>toArray()</code> method returns an array of the
 ...
 * <p>
 * The <code>toDynaBeanArray()</code> method returns a
 * <code>DynaBean[]</code> array of the elements in the List.
 * </p>
 *
 * <p>
 * <strong>N.B.</strong>All the elements in the List must be the
 ...
 * <h3>Example 1</h3>
 * <p>
 * If you have an array of <code>java.util.Map[]</code> - you can put that into
 * a <code>LazyDynaList</code>.
 * </p>
 *
 * <pre>
 * <code>
 ...
 * <h3>Example 2</h3>
 * <p>
 * Alternatively you can create an <i>empty</i> List and
 ...
 * <h3>Example 3</h3>
 * <p>
 * Alternatively you can create an <i>empty</i> List and specify the
 ...
 *
 * <p>
 * <strong>N.B.</strong> You may wonder why control the type
 ...
 * <code>add()</code>, <code>addAll()</code> or <code>set()</code>).
 * </p>
 *
 * <pre>
 * <code>
...
public class LazyDynaList extends ArrayList<Object>{
     ...
     * 
     */
    private static final long       serialVersionUID = -315007478508532067L;
     ...
     * <i>grown</i> to the appropriate size.
     * </p>
     *
     * @param index
     *            The index position to insert the new element.
     * @param element
     ...
     * size of the List, then the List is automatically
     * <i>grown</i> (and populated) to the appropriate size.
     * </p>
     *
     * @param index
     *            The index position to insert the new elements at.
     ...
     *
     * @param index
     *            The index position to insert the new element at.
     * @param element
     *            The new element.
    ...
    public <T> T[] toArray(final T[] model){
        ...
        if ((DynaBean.class.isAssignableFrom(arrayType)) || (size() == 0 && elementType == null)){
        ...
        throw new IllegalArgumentException(
                        "Invalid array type: " + arrayType.getName() + " - not compatible with '" + elementType.getName());
    ...
    /**
     * <p>
     * Automatically <i>grown</i> the List
