...
/**
 * <p>
 * <code>Predicate</code> that evaluates a property value against a specified value.
 * </p>
 * <p>
...
public class BeanPropertyValueEqualsPredicate implements Predicate{
    ...
    /** The Constant log. */
    private static final Logger LOGGER = LoggerFactory.getLogger(BeanPropertyValueEqualsPredicate.class);
    ...
    /**
     * <p>
     * Should <code>null</code> objects in the property path be ignored?
     * </p>
     * <p>
     ...
     *
     * @param propertyName
     *            The name of the property that will be evaluated against the expected value.
     * @param propertyValue
     *            The value to use in object evaluation.
