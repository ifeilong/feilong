...
public class BeanUtilsBean{
     ...
     *            use this <code>ConvertUtilsBean</code>
     ...
     *            use this <code>PropertyUtilsBean</code>
     ...
     *
     * <p>
     * If the origin "bean" is actually a <code>Map</code>, it is assumed
     ...
     *
     * <p>
     * This method differs from <code>populate()</code>, which
     ...
     *
     * <p>
     * <strong>FIXME</strong> - Indexed and mapped properties that do not
     ...
     *
     * <p>
     * <strong>Warning:</strong> if any of the bean property implementations
    ...
    public Map<String, String> describe(final Object bean) throws IllegalAccessException,InvocationTargetException,NoSuchMethodException{
        ...
        if (bean instanceof DynaBean){
            ...
            for (PropertyDescriptor descriptor : descriptors){
                final String name = descriptor.getName();
                getPropertyUtils();
                if (PropertyUtilsBean.getReadMethod(clazz, descriptor) != null){
                    description.put(name, getProperty(bean, name));
                }
            }
        }
     ...
     *
     * <p>
     * <strong>WARNING</strong> - The logic of this method is customized
     ...
     * <code>copyProperties()</code> method instead.
     * </p>
     *
     * @param bean
     ...
     *
     * <p>
     * If <code>null</code> is passed into a property expecting a primitive value,
     * then this will be converted as if it were a <code>null</code> string.
     * </p>
     *
     * <p>
     * <strong>WARNING</strong> - The logic of this method is customized
