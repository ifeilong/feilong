...
public abstract class BaseLocaleConverter implements LocaleConverter{
     ...
     *            The convertion pattern
     * @param useDefault
     *            Indicate whether the default value is used or not
     * @param locPattern
     *            Indicate whether the pattern is localized or not
     */
    private BaseLocaleConverter(final Object defaultValue, final Locale locale, final String pattern, final boolean useDefault,
