 ...
 *
 * <p>
 * The meta contains an <em>optional</em> content type property ({@link #getContentType})
...
public class DynaProperty implements Serializable{
     ...
     * There are issues with serializing primitive class types on certain JVM versions
     * (including java 1.3).
     * Therefore, this field <strong>must not be serialized using the standard methods</strong>.
     * </p>
     *
     * <p>
     * <strong>Please leave this field as <code>transient</code></strong>
     * </p>
     *
    ...
    public boolean equals(final Object obj){
        ...
        if ((!result) && obj instanceof DynaProperty){
            ...
            result = ((this.name == null) ? (that.name == null) : (this.name.equals(that.name)))
