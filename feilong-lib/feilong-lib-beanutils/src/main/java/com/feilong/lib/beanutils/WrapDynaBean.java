 ...
 *
 * <p>
 * <strong>IMPLEMENTATION NOTE</strong> - This implementation does not
 * support the <code>contains()</code> and <code>remove()</code> methods.
 * </p>
 *
 * @version $Id$
 */
public class WrapDynaBean implements DynaBean,Serializable{
     ...
     * 
     */
    private static final long serialVersionUID = -2177401532100818092L;
     ...
     *            JavaBean instance to be wrapped
     * @param cls
     *            the optional {@code WrapDynaClass} to be used for this bean
     * @since 1.9
     */
