 ...
 * However, an <code>IllegalAccessException</code> is thrown if the constructors is invoked.
 * </p>
 *
 * <p>
 * <code>ConstructorUtils</code> contains a workaround for this situation.
...
public class ConstructorUtils{
    ...
    /**
     * <p>
     * Convenience method returning new instance of <code>klazz</code> using a single argument constructor.
     ...
     * @param arg
     *            the actual argument. May be null (this will result in calling the default constructor).
    ...
    /**
     * <p>
     * Returns new instance of <code>klazz</code> created using the actual arguments <code>args</code>.
    ...
    /**
     * <p>
     * Returns new instance of <code>klazz</code> created using constructor
     * with signature <code>parameterTypes</code> and actual arguments <code>args</code>.
     * </p>
     *
     * <p>
     * The signatures should be assignment compatible.
