 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link com.feilong.lib.org.apache.http.config.Registry}
 */
...
public final class AuthSchemeRegistry implements Lookup<AuthSchemeProvider>{
     ...
     * @param factory
     *            the {@link AuthSchemeFactory} class to register
     *
     * @see #getAuthScheme
     */
     ...
     *
     * @param name
     *            the {@link AuthScheme authentication scheme} identifier
     * @param params
     *            the {@link HttpParams HTTP parameters} for the authentication
     *            scheme.
     *
