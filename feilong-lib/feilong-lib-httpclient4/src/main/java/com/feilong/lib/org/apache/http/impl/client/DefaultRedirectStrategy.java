...
import com.feilong.lib.org.apache.http.client.CircularRedirectException;
...
import com.feilong.lib.org.apache.http.client.methods.RequestBuilder;
...
public class DefaultRedirectStrategy implements RedirectStrategy{
    ...
    /**
     * @deprecated (4.3) use {@link com.feilong.lib.org.apache.http.client.protocol.HttpClientContext#REDIRECT_LOCATIONS}.
     */
    @Deprecated
     ...
     *
     * @param redirectMethods
     *            The methods to redirect.
     * @since 4.5.10
     */
    ...
    public URI getLocationURI(final HttpRequest request,final HttpResponse response,final HttpContext context) throws ProtocolException{
        ...
        try{
            ...
            if (!uri.isAbsolute()){
                ...
                final URI absoluteRequestURI = URIUtils
                                .rewriteURI(requestURI, target, config.isNormalizeUri() ? URIUtils.NORMALIZE : URIUtils.NO_FLAGS);
