...
package com.feilong.lib.org.apache.http.conn.routing;
...
public final class HttpRoute implements RouteInfo,Cloneable{
    ...
    private HttpRoute(final HttpHost target, final InetAddress local, final List<HttpHost> proxies, final boolean secure,
    ...
    private static HttpHost normalize(final HttpHost target){
        ...
        return address != null ? new HttpHost(address, getDefaultPort(schemeName), schemeName)
     ...
     * @param secure
     *            {@code true} if the route is (to be) secure,
     ...
     */
    public HttpRoute(final HttpHost target, final InetAddress local, final HttpHost[] proxies, final boolean secure,
                    final TunnelType tunnelled, final LayerType layered){
     ...
     *            {@code false} otherwise
     * @param tunnelled
     *            {@code true} if the route is (to be) tunnelled
     *            via the proxy,
     *            {@code false} otherwise
     * @param layered
     *            {@code true} if the route includes a
     *            layered protocol,
     *            {@code false} otherwise
     */
    public HttpRoute(final HttpHost target, final InetAddress local, final HttpHost proxy, final boolean secure, final TunnelType tunnelled,
    ...
    public HttpRoute(final HttpHost target, final InetAddress local, final HttpHost proxy, final boolean secure){
        this(target, local, Collections.singletonList(Args.notNull(proxy, "Proxy host")), secure,
                        secure ? TunnelType.TUNNELLED : TunnelType.PLAIN, secure ? LayerType.LAYERED : LayerType.PLAIN);
    }
    ...
    public boolean equals(final Object obj){
        ...
        if (obj instanceof HttpRoute){
            ...
            (this.secure == that.secure) && (this.tunnelled == that.tunnelled) && (this.layered == that.layered)
                            && LangUtils.equals(this.targetHost, that.targetHost) && LangUtils.equals(this.localAddress, that.localAddress)
