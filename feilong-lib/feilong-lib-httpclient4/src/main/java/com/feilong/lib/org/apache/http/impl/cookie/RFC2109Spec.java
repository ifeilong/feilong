...
import com.feilong.lib.org.apache.http.client.utils.DateUtils;
...
import com.feilong.lib.org.apache.http.cookie.CookiePathComparator;
...
/**
 * RFC 2109 compliant {@link com.feilong.lib.org.apache.http.cookie.CookieSpec} implementation.
 * <p>
...
public class RFC2109Spec extends CookieSpecBase{
    ...
    public RFC2109Spec(final String[] datepatterns, final boolean oneHeader){
        ...
        }, new RFC2109DomainHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(), new BasicCommentHandler(),
                        new BasicExpiresHandler(datepatterns != null ? datepatterns.clone() : DATE_PATTERNS));
     ...
     * 
     * @param buffer
     *            The char array buffer to use for output
     * @param name
     *            The cookie name
     * @param value
     *            The cookie value
