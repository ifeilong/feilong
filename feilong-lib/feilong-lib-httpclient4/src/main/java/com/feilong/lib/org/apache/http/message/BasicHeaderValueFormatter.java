...
package com.feilong.lib.org.apache.http.message;
...
public class BasicHeaderValueFormatter implements HeaderValueFormatter{
     ...
     * @param quote
     *            {@code true} to always format with quoted values,
     *            {@code false} to use quotes only when necessary
     * @param formatter
     *            the formatter to use, or {@code null}
     ...
     *
     * @param elems
     *            the header elements to format, or {@code null}
     *
     ...
     *
     * @param elem
     *            the header element to format, or {@code null}
     *
     * @return a length estimate, in number of characters
     */
     ...
     *
     * @param nvps
     *            the parameters to format, or {@code null}
     *
     * @return a length estimate, in number of characters
     */
     ...
     * @param quote
     *            {@code true} to always format with a quoted value,
     *            {@code false} to use quotes only when necessary
     * @param formatter
     *            the formatter to use, or {@code null}
     *            for the {@link #INSTANCE default}
     ...
     *
     * @param nvp
     *            the name-value pair to format, or {@code null}
     *
     * @return a length estimate, in number of characters
     */
     ...
     *
     * @param buffer
     *            the buffer to append to, never {@code null}
     * @param value
     *            the value to append, never {@code null}
     * @param quote
     *            {@code true} to always format with quotes,
     *            {@code false} to use quotes only when necessary
     */
