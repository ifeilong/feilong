...
package com.feilong.lib.org.apache.http.conn.scheme;
 ...
 * @since 4.1
 *
 * @deprecated (4.3) use {@link com.feilong.lib.org.apache.http.conn.socket.ConnectionSocketFactory}
 */
@Deprecated
public interface SchemeSocketFactory{
     ...
     *
     * @param params
     *            Optional {@link HttpParams parameters}. In most cases these parameters
     ...
     * <p>
     * Please note that {@link com.feilong.lib.org.apache.http.conn.HttpInetSocketAddress} class should
     * be used in order to pass the target remote address along with the original
     * {@link com.feilong.lib.org.apache.http.HttpHost} value used to resolve the address. The use of
     * {@link com.feilong.lib.org.apache.http.conn.HttpInetSocketAddress} can also ensure that no reverse
     ...
     *
     * @see com.feilong.lib.org.apache.http.conn.HttpInetSocketAddress
     */
    Socket connectSocket(Socket sock,InetSocketAddress remoteAddress,InetSocketAddress localAddress,HttpParams params)
