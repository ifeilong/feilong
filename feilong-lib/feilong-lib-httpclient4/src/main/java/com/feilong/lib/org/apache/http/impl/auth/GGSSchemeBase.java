...
import com.feilong.lib.org.apache.http.auth.InvalidCredentialsException;
import com.feilong.lib.org.apache.http.auth.KerberosCredentials;
...
public abstract class GGSSchemeBase extends AuthSchemeBase{
     ...
     * @since 4.4
     */
    protected byte[] generateGSSToken(final byte[] input,final Oid oid,final String authServer,final Credentials credentials)
                    throws GSSException{
        ...
        return input != null ? gssContext.initSecContext(input, 0, input.length) : gssContext.initSecContext(new byte[] {}, 0, 0);
    }

    GSSContext createGSSContext(final GSSManager manager,final Oid oid,final GSSName serverName,final GSSCredential gssCredential)
                    throws GSSException{
    ...
    /**
     * @deprecated (4.4) Use {@link #generateToken(byte[], String, com.feilong.lib.org.apache.http.auth.Credentials)}.
     */
    @Deprecated
    ...
    /**
     * @deprecated (4.2) Use {@link com.feilong.lib.org.apache.http.auth.ContextAwareAuthScheme#authenticate(
     *             Credentials, HttpRequest, com.feilong.lib.org.apache.http.protocol.HttpContext)}
     */
    @Override
    @Deprecated
