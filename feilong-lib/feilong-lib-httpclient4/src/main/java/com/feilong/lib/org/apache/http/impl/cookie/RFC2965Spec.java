...
import com.feilong.lib.org.apache.http.annotation.Obsolete;
...
/**
 * RFC 2965 compliant {@link com.feilong.lib.org.apache.http.cookie.CookieSpec} implementation.
 * <p>
 * Rendered obsolete by {@link com.feilong.lib.org.apache.http.impl.cookie.RFC6265StrictSpec}.
 *
 * @since 4.0
 * @see com.feilong.lib.org.apache.http.impl.cookie.RFC6265StrictSpec
 */
@Obsolete
...
public class RFC2965Spec extends RFC2109Spec{
            ...
            public void validate(final Cookie cookie,final CookieOrigin origin) throws MalformedCookieException{
                if (!match(cookie, origin)){
                    throw new CookieRestrictionViolationException(
                                    "Illegal 'path' attribute \"" + cookie.getPath() + "\". Path of origin: \"" + origin.getPath() + "\"");
                }
            }

        }, new RFC2965DomainAttributeHandler(), new RFC2965PortAttributeHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(),
                        new BasicCommentHandler(), new BasicExpiresHandler(datepatterns != null ? datepatterns.clone() : DATE_PATTERNS),
                        new RFC2965CommentUrlAttributeHandler(), new RFC2965DiscardAttributeHandler());
    }
    ...
    private List<Cookie> createCookies(final HeaderElement[] elems,final CookieOrigin origin) throws MalformedCookieException{
        ...
        for (final HeaderElement headerelement : elems){
            ...
            final Map<String, NameValuePair> attribmap = new HashMap<>(attribs.length);
     ...
     *
     * @param origin
     *            origin where cookie is received from or being sent to.
     */
