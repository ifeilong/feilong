...
/**
 * This {@link com.feilong.lib.org.apache.http.cookie.CookieSpec} implementation conforms to
 ...
 * legacy applications.
 * <p>
 * Rendered obsolete by {@link com.feilong.lib.org.apache.http.impl.cookie.RFC6265LaxSpec}.
 *
 * @since 4.0
 * @see com.feilong.lib.org.apache.http.impl.cookie.RFC6265LaxSpec
 */
@Obsolete
...
public class NetscapeDraftSpec extends CookieSpecBase{
    ...
    public NetscapeDraftSpec(final String[] datepatterns){
        super(new BasicPathHandler(), new NetscapeDomainHandler(), new BasicSecureHandler(), new BasicCommentHandler(),
                        new BasicExpiresHandler(datepatterns != null ? datepatterns.clone() : new String[] { EXPIRES_PATTERN }));
    }
