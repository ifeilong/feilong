...
import com.feilong.lib.org.apache.http.cookie.CookiePriorityComparator;
...
import com.feilong.lib.org.apache.http.message.TokenParser;
...
public class RFC6265CookieSpec implements CookieSpec{
    ...
    private static final BitSet                       SPECIAL_CHARS   = TokenParser
                    .INIT_BITSET(' ', DQUOTE_CHAR, COMMA_CHAR, PARAM_DELIMITER, ESCAPE_CHAR);
    ...
    public final List<Cookie> parse(final Header header,final CookieOrigin origin) throws MalformedCookieException{
        ...
        while (!cursor.atEnd()){
            final String paramName = tokenParser.parseToken(buffer, cursor, TOKEN_DELIMS).toLowerCase(Locale.ROOT);
