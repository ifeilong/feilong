...
public class BasicScheme extends RFC2617Scheme{
     ...
     * @throws com.feilong.lib.org.apache.http.auth.InvalidCredentialsException
     *             if authentication
    ...
    public Header authenticate(final Credentials credentials,final HttpRequest request,final HttpContext context)
        ...
        final byte[] base64password = base64codec.encode(EncodingUtils.getBytes(tmp.toString(), getCredentialsCharset(request)));
