...
import com.feilong.lib.org.apache.http.conn.HttpHostConnectException;
        ...
        for (int i = 0; i < addresses.length; i++){
            ...
            try{
                ...
                if (last){
                    ...
                    throw "Connection timed out".equals(msg) ? new ConnectTimeoutException(ex, host, addresses)
