...
package com.feilong.lib.org.apache.http.util;
...
public final class LangUtils{
     ...
     *
     * @param obj1
     *            first object to compare, may be {@code null}
     * @param obj2
     *            second object to compare, may be {@code null}
     ...
     *
     * @param a1
     *            first array to compare, may be {@code null}
     * @param a2
     *            second array to compare, may be {@code null}
