...
import com.feilong.lib.org.apache.http.conn.routing.BasicRouteDirector;
import com.feilong.lib.org.apache.http.conn.routing.HttpRoute;
import com.feilong.lib.org.apache.http.conn.routing.HttpRouteDirector;
import com.feilong.lib.org.apache.http.conn.routing.RouteTracker;
...
public class MainClientExec implements ClientExecChain{
    ...
    public MainClientExec(final HttpRequestExecutor requestExecutor, final HttpClientConnectionManager connManager,
                    ...
                    final HttpProcessor proxyHttpProcessor, final AuthenticationStrategy targetAuthStrategy,
    ...
    public MainClientExec(final HttpRequestExecutor requestExecutor, final HttpClientConnectionManager connManager,
        ...
        this(requestExecutor, connManager, reuseStrategy, keepAliveStrategy, new ImmutableHttpProcessor(new RequestTargetHost()),
    ...
    private boolean needAuthentication(
        ...
        if (config.isAuthenticationEnabled()){
            ...
            final boolean targetAuthRequested = this.authenticator
                            .isAuthenticationRequested(target, response, this.targetAuthStrategy, targetAuthState, context);
            ...
            final boolean proxyAuthRequested = this.authenticator
                            .isAuthenticationRequested(proxy, response, this.proxyAuthStrategy, proxyAuthState, context);
