...
/**
 * {@link com.feilong.lib.org.apache.http.cookie.CookieSpecProvider} implementation that provides an instance of
 * {@link RFC2109Spec}. The instance returned by this factory
 * can be shared by multiple threads.
 * <p>
 * Rendered obsolete by {@link com.feilong.lib.org.apache.http.impl.cookie.RFC6265CookieSpecProvider}
 *
 * @since 4.4
 * @see com.feilong.lib.org.apache.http.impl.cookie.RFC6265CookieSpecProvider
 */
@Obsolete
...
public class RFC2109SpecProvider implements CookieSpecProvider{
    ...
    public CookieSpec create(final HttpContext context){
        if (cookieSpec == null){
            synchronized (this){
                if (cookieSpec == null){
                    this.cookieSpec = new RFC2109Spec(
                                    this.oneHeader,
