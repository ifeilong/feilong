...
import com.feilong.lib.javassist.bytecode.stackmap.BasicBlock;
 ...
 *
 * <p>
 * <code>blocks</code> is an array of basic blocks in
 * that method body.
 * </p>
 *
    ...
    public static class Block extends BasicBlock{
        ...
        protected void toString2(StringBuffer sbuf){
            ...
            for (Block entrance : entrances){
                sbuf.append(entrance.position).append(", ");
            }
    ...
    public static class Node{
        ...
        public String toString(){
            ...
            for (Node element : children){
                sbuf.append(element.block().position()).append(", ");
            }
        ...
        boolean makeDominatorTree(boolean[] visited,int[] distance,Access access){
            ...
            if (entrances != null){
                for (BasicBlock entrance : entrances){
                    if (parent != null){
                        Node n = getAncestor(parent, access.node(entrance), distance);
                        if (n != parent){
                            parent = n;
                            changed = true;
                        }
