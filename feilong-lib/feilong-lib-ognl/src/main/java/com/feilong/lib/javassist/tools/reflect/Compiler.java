 ...
 *
 * <p>
 * The modified class files are given as the command-line parameters,
 * which are a sequence of fully-qualified class names followed by options:
 *
 * <p>
 * <code>-m <i>classname</i></code> : specifies the class of the
 ...
 *
 * <p>
 * <code>-c <i>classname</i></code> : specifies the class of the
 ...
 *
 * <p>
 * If a class name is not followed by any options, the class indicated
 ...
 *
 * <p>
 * modifies class files <code>Dog.class</code>, <code>Cat.class</code>,
