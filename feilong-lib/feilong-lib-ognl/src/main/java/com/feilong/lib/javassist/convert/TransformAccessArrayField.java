...
import com.feilong.lib.javassist.CodeConverter.ArrayAccessReplacementMethodNames;
...
import com.feilong.lib.javassist.bytecode.analysis.Analyzer;
import com.feilong.lib.javassist.bytecode.analysis.Frame;
...
public final class TransformAccessArrayField extends Transformer{
    ...
    public TransformAccessArrayField(Transformer next, String methodClassname, ArrayAccessReplacementMethodNames names)
    ...
    public void initialize(ConstPool cp,CtClass clazz,MethodInfo minfo) throws CannotCompileException{
        ...
        while (iterator.hasNext()){
            try{
                ...
                }else if (c == AASTORE || c == BASTORE || c == CASTORE || c == DASTORE || c == FASTORE || c == IASTORE || c == LASTORE
                                || c == SASTORE){
