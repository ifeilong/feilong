...
package com.feilong.lib.javassist.tools.rmi;
...
public class StubGenerator implements Translator{
    ...
    private static final String        sampleClass      = "com.feilong.lib.javassist.tools.rmi.Sample";

    private ClassPool                  classPool;

    private final Map<String, CtClass> proxyClasses;
     ...
     *
     * @see com.feilong.lib.javassist.Translator#start(ClassPool)
     */
    @Override
    public void start(ClassPool pool) throws NotFoundException{
        ...
        proxyConstructorParamTypes = pool.get(new String[] { "com.feilong.lib.javassist.tools.rmi.ObjectImporter", "int" });
        interfacesForProxy = pool.get(new String[] { "java.io.Serializable", "com.feilong.lib.javassist.tools.rmi.Proxy" });
        exceptionForProxy = new CtClass[] { pool.get("com.feilong.lib.javassist.tools.rmi.RemoteException") };
    }
     ...
     * This is a method declared in javassist.Translator.
     * 
     * @see com.feilong.lib.javassist.Translator#onLoad(ClassPool,String)
     */
    @Override
    ...
    private CtClass produceProxyClass(CtClass orgclass,Class<?> orgRtClass) throws CannotCompileException,NotFoundException{
        ...
        CtField f = new CtField(classPool.get("com.feilong.lib.javassist.tools.rmi.ObjectImporter"), fieldImporter, proxy);
