...
class CtClassType extends CtClass{
    ...
    static Object[][] toAnnotationType(
        ...
        try{
            ...
            try{
                ...
                try{
                    ...
                    return com.feilong.lib.javassist.bytecode.annotation.AnnotationImpl.make(clazz.getClassLoader(), clazz, cp, anno);
                }catch (Throwable e3){
    ...
    /**
     * @see com.feilong.lib.javassist.CtClass#prune()
     * @see com.feilong.lib.javassist.CtClass#stopPruning(boolean)
     */
    @Override
    public void prune(){
        if (wasPruned)
