...
public class ParseException extends Exception{
     ...
     *            the int[] array containing the expected token sequence values.
     * @param tokenImageVal
     *            the Token Image value array providing additional state information about the parse failure.
     */
     ...
     * 
     * @param message
     *            a simple String message indicating the type of parse failure.
     */
