 ...
 *
 * <p>
 * <code>ClassPool</code> objects hold all the <code>CtClass</code>es
...
public class ClassPool{
     ...
     *
     * <p>
     * If this field is true, <code>get()</code> first searches the
     ...
     *
     * <p>
     * If this field is true, <code>CtClass</code> objects are
     ...
     *
     * <p>
     * Since version 3.14, <code>packageName</code> can be a
     * fully-qualified class name.
     *
     * <p>
     * Note that <code>get()</code> in <code>ClassPool</code> does
     ...
     *
     * <p>
     * If <code>classname</code> ends with "[]", then this method
     ...
     *
     * <p>
     * If an element of <code>classnames</code> ends with "[]",
     * then this method
     * returns a <code>CtClass</code> object for that array type.
     *
     * @param classnames
     ...
     *
     * <p>
     * This method is used for creating a <code>CtClass</code> object
     ...
     *
     * <p>
     * <b>Warining:</b> A Class object returned by this method may not
     * work with a security manager or a signed jar file because a
     * protection domain is not specified.
     *
