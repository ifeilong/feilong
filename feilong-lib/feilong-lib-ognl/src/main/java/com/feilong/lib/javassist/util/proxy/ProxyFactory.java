 ...
 *
 * <p>
 * A proxy object generated by <code>ProxyFactory</code> is serializable
...
public class ProxyFactory{
    ...
    private static Comparator<Map.Entry<String, Method>> sorter = (e1,e2) -> e1.getKey().compareTo(e2.getKey());
    ...
    private static void addClassInitializer(ClassFile cf,ConstPool cp,String classname,int size,List<Find2MethodsArgs> forwarders)
    ...
    private void override(
                    ...
                    ClassFile cf,
                    ConstPool cp,
                    List<Find2MethodsArgs> forwarders) throws CannotCompileException{
