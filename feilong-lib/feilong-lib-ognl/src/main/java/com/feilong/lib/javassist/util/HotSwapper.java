...
package com.feilong.lib.javassist.util;
 ...
 *
 * <p>
 * <b>Note:</b> The new definition of the reloaded class must declare
 ...
 *
 * <p>
 * Note that 8000 is the port number used by <code>HotSwapper</code>.
 ...
 *
 * <p>
 * Furthermore, <code>JAVA_HOME/lib/tools.jar</code> must be included
 * in the class path.
 *
 * <p>
 ...
 *
 * <p>
 * {@code HotSwap} depends on the debug agent to perform hot-swapping
