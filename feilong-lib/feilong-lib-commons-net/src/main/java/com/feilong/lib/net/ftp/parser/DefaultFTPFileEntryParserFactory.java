...
import com.feilong.lib.net.ftp.Configurable;
import com.feilong.lib.net.ftp.FTPClientConfig;
import com.feilong.lib.net.ftp.FTPFileEntryParser;
 ...
 *
 * @see com.feilong.lib.net.ftp.FTPClient#listFiles
 * @see com.feilong.lib.net.ftp.FTPClient#setParserFactory
 */
public class DefaultFTPFileEntryParserFactory implements FTPFileEntryParserFactory{
     ...
     * 
     * @param config
     *            A {@link FTPClientConfig FTPClientConfig}
            ...
            return new CompositeFileEntryParser(
                            new FTPFileEntryParser[] {
                                                       ...
                                                       new UnixFTPEntryParser(
                                                                       config2,
                                                                       config2 != null && FTPClientConfig.SYST_UNIX_TRIM_LEADING
                                                                                       .equals(config2.getServerSystemKey())) });
        }
    }
