...
public class NumberUtils{
     ...
     *
     * @param value
     *            the {@code BigDecimal} to convert, may be {@code null}.
     ...
     *
     * @param value
     *            the {@code BigDecimal} to convert, may be null.
     ...
     *
     * @param value
     *            the {@code Float} to convert, may be null.
     * @return the scaled, with appropriate rounding, {@code BigDecimal}.
     * @since 3.8
     */
     ...
     *
     * @param value
     *            the {@code Double} to convert, may be null.
     * @return the scaled, with appropriate rounding, {@code BigDecimal}.
     * @since 3.8
     */
     ...
     *
     * @param value
     *            the {@code String} to convert, may be null.
     * @return the scaled, with appropriate rounding, {@code BigDecimal}.
     * @since 3.8
     */
     ...
     *
     * <p>
     * Hexadecimal and scientific notations are <strong>not</strong> considered parsable.
