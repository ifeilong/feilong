...
public interface DateParser{
     ...
     * 
     * @param source
     *            A {@code String} whose beginning should be parsed.
     ...
     *
     * @param source
     *            A {@code String}, part of which should be parsed.
     * @param pos
     *            A {@code ParsePosition} object with index and error index information
     *            as described above.
