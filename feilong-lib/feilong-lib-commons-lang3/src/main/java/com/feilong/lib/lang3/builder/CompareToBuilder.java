...
public class CompareToBuilder implements Builder<Integer>{
     ...
     *             if {@code rhs} is not assignment-compatible
     *             with {@code lhs}
     */
     ...
     *         is less than, equal to, or greater than {@code rhs}
     * @throws NullPointerException
     *             if either {@code lhs} or {@code rhs}
     ...
     *            right-hand object
     * @param clazz
     *            {@code Class} that defines fields to be compared
     * @param builder
     *            {@code CompareToBuilder} to append to
     * @param useTransients
     *            whether to compare transient fields
     * @param excludeFields
     *            fields to exclude
     ...
     *            result of calling {@code super.compareTo(Object)}
     ...
     *            right-hand object
     * @param comparator
     *            {@code Comparator} used to compare the objects,
     ...
     *            right-hand array
     * @param comparator
     *            {@code Comparator} to use to compare the array elements,
