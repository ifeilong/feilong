...
public class FastDateParser implements DateParser,Serializable{
     ...
     *
     * @param pattern
     *            non-null {@link java.text.SimpleDateFormat} compatible
     *            pattern
     * @param timeZone
     ...
     *            the {@link java.util.Calendar} instance used to initialize this FastDateParser
     */
     ...
     *
     * @see com.feilong.lib.lang3.time.DateParser#parse(java.lang.String, java.text.ParsePosition)
     */
    @Override
     ...
     *            The text to parse.
     * @param pos
     *            On input, the position in the source to start parsing, on output, updated position.
     * @param calendar
