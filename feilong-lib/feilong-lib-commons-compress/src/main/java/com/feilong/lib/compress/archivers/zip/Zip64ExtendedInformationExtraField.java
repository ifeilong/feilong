...
public class Zip64ExtendedInformationExtraField implements ZipExtraField{
    ...
    public ZipShort getCentralDirectoryLength(){
        return new ZipShort(
                        (size != null ? DWORD : 0) + (compressedSize != null ? DWORD : 0) + (relativeHeaderOffset != null ? DWORD : 0)
            ...
            if (rawCentralDirectoryData.length < expectedLength){
                throw new ZipException(
                                "Central directory zip64 extended" + " information extra field's length"
                                                + " doesn't match central directory" + " data.  Expected length " + expectedLength
