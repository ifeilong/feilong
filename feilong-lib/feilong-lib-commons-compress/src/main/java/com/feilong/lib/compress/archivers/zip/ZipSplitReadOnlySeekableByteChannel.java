...
import com.feilong.lib.compress.utils.MultiReadOnlySeekableByteChannel;

/**
 * {@link MultiReadOnlySeekableByteChannel} that knows what a split ZIP archive should look like.
 *
 * <p>
 * If you want to read a split archive using {@link ZipFile} then create an instance of this class from the parts of
 * the archive.
 * </p>
 *
 * @since 1.20
...
public class ZipSplitReadOnlySeekableByteChannel extends MultiReadOnlySeekableByteChannel{
     ...
     *             the beginning of a split archive
     */
    public static SeekableByteChannel forOrderedSeekableByteChannels(
                    SeekableByteChannel lastSegmentChannel,
     ...
     *             if the lastSegmentFile's extension is NOT .zip
     * @throws IOException
     *             if the first channel doesn't seem to hold
     *             the beginning of a split archive
     */
