...
public class JsonlibXmlUtil{
     ...
     * 
     * <p>
     * <a href="http://json-lib.sourceforge.net/apidocs/net/sf/json/xml/XMLSerializer.html">XMLSerializer API</a>:
     * <a href="http://json-lib.sourceforge.net/xref-test/net/sf/json/xml/TestXMLSerializer_writes.html">具体实例请参考</a>
     * </p>
     * 
     * <p>
     * 需要xom jar
     ...
     * @return the string
     * @see JsonHelper#toJSON(Object, net.sf.json.JsonConfig)
    ...
    public static String objectToXML(Object object,String encoding){
        //        JSON json = JsonHelper.toJSON(object, null);
