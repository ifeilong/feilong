...
public class ToStringBeanExcludesTest extends AbstractJsonTest{

    @SuppressWarnings("unchecked")
    @Test
    public void testExcludes(){
        String format = JsonUtil.toString(USER, toArray("name", "loves", "attrMap", "userInfo", "userAddresses"));
        assertThat(
                        format,
                        allOf(//
    ...
    public void testExcludes2(){
        String format = JsonUtil.toString(USER, "name", "loves", "attrMap", "userInfo", "userAddresses");
        assertThat(
                        format,
                        allOf(//
                                        containsString("userAddresseList"),
