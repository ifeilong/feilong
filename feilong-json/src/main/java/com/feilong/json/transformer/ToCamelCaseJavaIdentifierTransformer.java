 ...
 * @since 4.5.2
 */
public class ToCamelCaseJavaIdentifierTransformer extends JavaIdentifierTransformer{

    /** 下划线 transformer 'member_no' {@code =>} 'memberNo'. */
    public static final JavaIdentifierTransformer INSTANCE  = new ToCamelCaseJavaIdentifierTransformer();
     ...
     */
    public ToCamelCaseJavaIdentifierTransformer(){
        super();
    }
     ...
     *            the separator
     */
    public ToCamelCaseJavaIdentifierTransformer(char separator){
        super();
