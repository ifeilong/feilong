 ...
 * @since 1.11.5
 */
public class ResolverFilePathAndLineNumberReaderTest{
    ...
    public void testReadFileToStringFilePathAndCharsetNameTestNull(){
        IOReaderUtil.resolverFile((String) null, lineNumberReaderResolver);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testReadFileToStringFilePathAndCharsetNameTestEmpty(){
        IOReaderUtil.resolverFile("", lineNumberReaderResolver);
    }
    ...
    public void testReadFileToStringFilePathNull(){
        IOReaderUtil.resolverFile(SystemUtil.USER_HOME + "/work/build.xml", null);
    }
}
