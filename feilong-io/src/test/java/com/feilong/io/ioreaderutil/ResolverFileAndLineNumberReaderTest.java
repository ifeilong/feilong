 ...
 * @since 1.11.5
 */
public class ResolverFileAndLineNumberReaderTest{
    ...
    public void testReadFileToStringFilePathAndCharsetNameTestNull(){
        IOReaderUtil.resolverFile((File) null, lineNumberReaderResolver);
    }

    //---------------------------------------------------------------
    @Test(expected = NullPointerException.class)
    public void testReadFileToStringFilePathNull(){
        IOReaderUtil.resolverFile(new File(SystemUtils.USER_HOME+ "/work/build.xml"), null);
    }
}
