 ...
 */
public class ReadToListFilePathAndReaderConfigTest extends AbstractReadFileToStringTest{
    ...
    public void testReadFilePathAndReaderConfigTestNull(){
        IOReaderUtil.readToList((String) null, new ReaderConfig());
    }
    ...
    public void testReadFilePathAndReaderConfigTestEmpty(){
        IOReaderUtil.readToList("", new ReaderConfig());
    }
    ...
    public void testResolverReaderAndReaderConfigTest1(){
        List<String> codes = IOReaderUtil.readToList(filePath1, new ReaderConfig("[0-9a-zA-Z\\-]{6,20}"));
    ...
    public void testResolverReaderAndReaderConfigTest2(){
        List<String> codes = IOReaderUtil.readToList(filePath1, new ReaderConfig());
        assertThat(codes, allOf(hasItem("123456"), hasItem("23456")));
    }

    @Test
    public void testResolverReaderAndReaderConfigTest23(){
        List<String> codes = IOReaderUtil.readToList(filePath1, null);
        assertThat(codes, allOf(hasItem("123456"), hasItem("23456")));
    }
    ...
    public void testResolverReaderAndReaderConfigTest3(){
        List<String> codes = IOReaderUtil.readToList(filePath1, new ReaderConfig(true, false));
    ...
    public void testResolverReaderAndReaderConfigTest4(){
        List<String> codes = IOReaderUtil.readToList(filePath1, new ReaderConfig(false, false));
    ...
    public void testResolverReaderAndReaderConfigTest5(){
        List<String> codes = IOReaderUtil.readToList(filePath1, new ReaderConfig(false, true));
        assertThat(codes, allOf(hasItem(""), hasItem(""), hasItem("123456"), hasItem("A"), hasItem("23456")));
    }
}
