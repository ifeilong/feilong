...
public class ReadToListTest extends AbstractReadFileToStringTest{
    ...
    public void testReadFilePathAndReaderConfigTestNull(){
        IOReaderUtil.readToList((String) null);
    }
    ...
    public void testResolverReaderAndReaderConfigTest2(){
        List<String> codes = IOReaderUtil.readToList(floderPath + "src/test/resources/readtest.txt");
