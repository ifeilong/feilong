...
public class ImageUtilTest{
    ...
    public static void main(String[] args){
        ...
        String format = "gif";
        String rgbFilename = FilenameUtil.getNewFileName(filename, format);
        cmyk2rgb(filename, rgbFilename, format);
    }

    /**
     * CMYK转RGB If 'filename' is a CMYK file, then convert the image into RGB, store it into a JPEG file, and 返回 the new filename.
     *
