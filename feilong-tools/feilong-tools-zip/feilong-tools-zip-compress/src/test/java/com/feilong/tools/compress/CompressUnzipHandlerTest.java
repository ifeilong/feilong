...
public class CompressUnzipHandlerTest{
    ...
    String                     unZipFilePath = "/Users/feilong/workspace/feilong/feilong/feilong-tools/feilong-tools-zip/feilong-tools-zip-api/src/test/resources/for-unzip.zip";

    @Test
    public void test(){
        unzipHandler.unzip(
                        unZipFilePath, //需要被解压的zip文件
                        "/Users/feilong/feilong/logs/" + nowTimestamp() + "Compress"); // 解压到文件路径
    }
