...
public class WriteVlookup同比Test extends AbstractSalesDataWriteTest{
    ...
    protected String buildTemplateLocation(){
        return ResourceUtils.CLASSPATH_URL_PREFIX + "销售数据/vlookupAnd同比/export-template-sales-vlookup.xlsx";
    }

    @Override
    protected String buildSheetDefinitionLocation(){
        return ResourceUtils.CLASSPATH_URL_PREFIX + "销售数据/vlookupAnd同比/sheets-definition.xml";
    }
